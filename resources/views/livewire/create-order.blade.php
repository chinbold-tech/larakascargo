<div id="form-create">
    <x-jet-form-section :submit="$action" class="mb-4">
        ...
        <x-slot name="description">
            {{ __('Lengkapi data berikut dan submit untuk membuat data order baru') }}
        </x-slot>
        ...
        <x-slot name="form">
            <div class="form-group col-span-6 sm:col-span-5">
                ...
                <small>Code</small>
                <x-jet-input id="code" type="text" class="mt-1 block w-full form-control shadow-none" wire:model.defer="order.code" />
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                ...
                <small>shipper_number neree oruul</small>
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                ...
                <small>shipper_addressee  oruul</small>
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                ...
                <small>reciever_nameoo  oruul</small>
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="ship_status" value="{{ __('ship_status') }}" />
                <x-jet-input id="ship_status" type="number" class="mt-1 block w-full form-control shadow-none" wire:model.defer="order.ship_status" />
                <x-jet-input-error for="order.ship_status" class="mt-2" />
            </div>

            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="shipping_box" value="{{ __('shipping_box') }}" />
                <x-jet-input id="shipping_box" type="text" class="mt-1 block w-full form-control shadow-none" wire:model.defer="order.shipping_box" />
                <x-jet-input-error for="order.shipping_box" class="mt-2" />
            </div>

            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="shipping_date" value="{{ __('shipping_date') }}" />
                <x-jet-input id="shipping_date" type="date" class="mt-1 block w-full form-control shadow-none" wire:model.defer="order.shipping_date" />
                <x-jet-input-error for="order.shipping_date" class="mt-2" />
            </div>
            ...
            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="recieved_name" value="{{ __('recieved_name') }}" />
                <x-jet-input id="recieved_name" type="text" class="mt-1 block w-full form-control shadow-none" wire:model.defer="order.recieved_name" />
                <x-jet-input-error for="order.recieved_name" class="mt-2" />
            </div>

            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="recieved_phone" value="{{ __('recieved_phone') }}" />
                <x-jet-input id="recieved_phone" type="number" class="mt-1 block w-full form-control shadow-none" wire:model.defer="order.recieved_phone" />
                <x-jet-input-error for="order.recieved_phone" class="mt-2" />
            </div>

            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="recieved_description" value="{{ __('recieved_description') }}" />
                <x-jet-input id="recieved_description" type="text" class="mt-1 block w-full form-control shadow-none" wire:model.defer="order.recieved_description" />
                <x-jet-input-error for="order.recieved_description" class="mt-2" />
            </div>
            
            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="recieved_date" value="{{ __('recieved_date') }}" />
                <x-jet-input id="recieved_date" type="date" class="mt-1 block w-full form-control shadow-none" wire:model.defer="order.recieved_date" />
                <x-jet-input-error for="order.recieved_date" class="mt-2" />
            </div>

            
            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="is_active" value="{{ __('is_active') }}" />
                <x-jet-input id="is_active" type="number" class="mt-1 block w-full form-control shadow-none" wire:model.defer="order.is_active" />
                <x-jet-input-error for="order.is_active" class="mt-2" />
            </div>

            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="user_id" value="{{ __('user_id') }}" />
                <x-jet-input id="user_id" type="number" class="mt-1 block w-full form-control shadow-none" wire:model.defer="order.user_id" />
                <x-jet-input-error for="order.user_id" class="mt-2" />
            </div>

            <div class="form-group col-span-6 sm:col-span-5">
                <x-jet-label for="customer_id" value="{{ __('customer_id') }}" />
                <x-jet-input id="customer_id" type="number" class="mt-1 block w-full form-control shadow-none" wire:model.defer="order.customer_id" />
